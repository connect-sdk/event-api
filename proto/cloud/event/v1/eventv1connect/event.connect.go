...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/connect-sdk/event-api/proto/cloud/event/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	EventServiceName = "cloud.event.v1.EventService"
)
...
const (
	...
	EventServicePushEventProcedure = "/cloud.event.v1.EventService/PushEvent"
)
...
// NewEventServiceClient constructs a client for the cloud.event.v1.EventService service. By
...
// PushEvent calls cloud.event.v1.EventService.PushEvent.
...
// EventServiceHandler is an implementation of the cloud.event.v1.EventService service.
...
func NewEventServiceHandler(svc EventServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/cloud.event.v1.EventService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedEventServiceHandler) PushEvent(context.Context, *connect.Request[v1.PushEventRequest]) (*connect.Response[v1.PushEventResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("cloud.event.v1.EventService.PushEvent is not implemented"))
}
